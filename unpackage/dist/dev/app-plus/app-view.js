...
Z([[2,'+'],[[2,'+'],[[2,'+'],[1,'2-'],[[7],[3,'index']]],[1,'-']],[[7],[3,'__i0__']]])
Z([3,'load data-v-7619d4de'])
Z([3,'123412'])
...
var x=['./components/index/index-item.wxml','./components/swiper-tabs/swiper-tabs.wxml','./components/uni-load-more/uni-load-more.wxml','./pages/add-input/add-input.wxml','./pages/index/index.wxml','./pages/news/news.wxml','./pages/paper/paper.wxml','./pages/search/search.wxml','./pages/user/user.wxml'];d_[x[0]]={}
...
var hG=_mz(z,'image',['class',3,'mode',1,'src',2],[],e,s,gg)
_(cF,hG)
var oH=_n('text')
...
var bO=_mz(z,'image',['lazyLoad',-1,'class',14,'mode',1,'src',2],[],e,s,gg)
_(eN,bO)
_(xC,eN)
}
var oD=_v()
...
var xQ=_mz(z,'image',['lazyLoad',-1,'class',19,'mode',1,'src',2],[],e,s,gg)
_(oP,xQ)
var oR=_n('text')
...
var xIB=_mz(z,'view',['bindtap',6,'class',1,'data-event-opts',2,'style',3],[],eFB,tEB,gg)
...
lCB.wxXCkey=2
_2z(z,4,aDB,e,s,gg,lCB,'tab','index','index')
_(cAB,oBB)
_(r,cAB)
return r
}
...
var z=gz$gwx_3()
var cLB=_mz(z,'view',['class',0,'hidden',1],[],e,s,gg)
...
_(oNB,oPB)
var lQB=_mz(z,'view',['class',9,'style',1],[],e,s,gg)
_(oNB,lQB)
var aRB=_mz(z,'view',['class',11,'style',1],[],e,s,gg)
_(oNB,aRB)
_(hMB,oNB)
var tSB=_n('view')
_rz(z,tSB,'class',13,e,s,gg)
var eTB=_mz(z,'view',['class',14,'style',1],[],e,s,gg)
_(tSB,eTB)
var bUB=_mz(z,'view',['class',16,'style',1],[],e,s,gg)
_(tSB,bUB)
...
_(hMB,oXB)
_(cLB,hMB)
var c3B=_mz(z,'text',['class',31,'style',1],[],e,s,gg)
...
var o0B=_mz(z,'swiper-tabs',['bind:__l',1,'bind:transIndex',1,'class',2,'currentIndex',3,'data-event-opts',4,'tabs',5,'vueId',6],[],e,s,gg)
_(b9B,o0B)
var xAC=_mz(z,'swiper',['bindchange',8,'class',1,'current',2,'data-event-opts',3,'style',4],[],e,s,gg)
var oBC=_v()
_(xAC,oBC)
var fCC=function(hEC,cDC,oFC,gg){
var oHC=_n('swiper-item')
_rz(z,oHC,'class',18,hEC,cDC,gg)
var lIC=_mz(z,'scroll-view',['class',19,'scrollY',1],[],hEC,cDC,gg)
var aJC=_v()
_(lIC,aJC)
var tKC=function(bMC,eLC,oNC,gg){
var oPC=_mz(z,'index-item',['article',26,'bind:__l',1,'class',2,'vueId',3],[],bMC,eLC,gg)
_(oNC,oPC)
return oNC
}
aJC.wxXCkey=4
_2z(z,23,tKC,hEC,cDC,gg,aJC,'item','__i0__','id')
_(oHC,lIC)
_(oFC,oHC)
return oFC
}
oBC.wxXCkey=4
_2z(z,15,fCC,e,s,gg,oBC,'item','index','index')
_(b9B,xAC)
var fQC=_n('view')
